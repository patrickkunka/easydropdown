...
The following example shows part of a React component using CSS Modules, and demonstrates how we can provide imported styles to the EasyDropDown factory function.
