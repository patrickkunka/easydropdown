...
(function(d){function e(){this.isField=!0;this.cutOff=this.inFocus=this.down=!1;this.wrapperClass="dropdown";this.onSelect=null}function f(a,b){var c=new e;c.init(a,b);c.instances.push(c)}e.prototype={constructor:e,instances:[],init:function(a,b){var c=this;d.extend(c,b);c.$select=d(a);c.options=[];c.isTouch="ontouchend"in document;c.$select.removeClass(c.wrapperClass).find("option").each(function(a){var b=d(this);b.is(":selected")&&(c.selected={index:a,title:b.text()},c.focusIndex=a);c.options.push({domNode:b[0],
title:b.text(),value:b.val(),selected:b.is(":selected")})});c.render()},render:function(){var a=this;a.$container=a.$select.wrap('<div class="'+a.wrapperClass+(a.isTouch?" touch":"")+'"/>').parent();a.$active=d('<span class="selected">'+a.selected.title+"</span>").appendTo(a.$container);a.$carat=d('<span class="carat"/>').appendTo(a.$container);a.$scrollWrapper=d("<div><ul></ul></div>").appendTo(a.$container);a.$dropDown=a.$scrollWrapper.find("ul");d.each(a.options,function(){a.$dropDown.append("<li"+
(this.selected?' class="active"':"")+">"+this.title+"</li>")});a.$items=a.$dropDown.find("li");for(i=a.maxHeight=0;i<a.$items.length;i++){var b=a.$items.eq(i);a.maxHeight+=b.outerHeight();if(a.cutOff==i+1)break}a.isTouch?a.bindTouchHandlers():a.bindHandlers()},bindTouchHandlers:function(){var a=this;a.$container.on("click",function(){a.$select.focus()});a.$select.on({change:function(){var b=d(this).find("option:selected").text();a.$active.text(b)},focus:function(){a.$container.addClass("focus")},
blur:function(){a.$container.removeClass("focus")}})},bindHandlers:function(){var a=this;a.query="";a.$container.on("click",function(){a.down?a.close():a.open()});d("body").on("click",function(b){!d(b.target).closest("."+a.wrapperClass).length&&a.down&&a.close()});a.$items.on({click:function(){var b=d(this).index();a.select(b)},mouseover:function(){var b=d(this);b.addClass("focus").siblings().removeClass("focus");a.focusIndex=b.index()},mouseout:function(){d(this).removeClass("focus")}});a.$select.on({focus:function(){a.$container.addClass("focus");
